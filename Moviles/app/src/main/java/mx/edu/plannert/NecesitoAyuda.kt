...
class NecesitoAyuda : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getSupportActionBar()?.setTitle(Html.fromHtml("<font color='#ffffff' size='5sp' font-family='@font/intermedium'>Volver / Necesito ayuda</font>"))
